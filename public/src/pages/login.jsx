...
const Login = () => {
  ...
  //     // Periksa payload token
  //     const decodedToken = jwtDecode(data.token);
  //     console.log("Decoded Token:", decodedToken);
  
  //     // Ekstrak peran pengguna dari token
  //     const levelUser = decodedToken.levelUser;
  //     console.log("Level User:", levelUser);
  ...
  // };
    ...
    const handleLogin = async (e) => {
      ...
      try {
        ...
        if (levelUser === 'admin') {
          navigate('/kategori');
          console.log('Redirecting to /kategori');
        } else if (levelUser === 'member') {
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#FDF9EC] py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="text-center mt-4">
        <p className="text-sm text-gray-600">
          ...
          <Link to="/registrasi" className="font-medium text-[#EA2020] hover:text-indigo-500">
            Register here
          </Link>
        </p>
      </div>
